...
if __name__ == '__main__':
    ...
    #############################################################################################################
    parser.add_argument("--pretrained_model", default='/group/40064/johnbli/bert-based-models/roberta-large', type=str, help="pretrained_model")
    parser.add_argument("--pretrained_model_hidden_size", default=1024, type=int, help="hidden_size of PLM")
    #############################################################################################################
    ...
    setattr(args, 'tokenizer', AutoTokenizer.from_pretrained(args.pretrained_model))
    ...
    labeled_samples_filepath = f'./SRVF-main/data/{args.dataset}/sampled_{str(args.k_shot)}_shot_train.json'
